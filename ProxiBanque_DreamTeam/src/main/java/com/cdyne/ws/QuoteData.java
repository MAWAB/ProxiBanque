...
public class QuoteData {
	...
	public String toString() {
		return "QuoteData [stockSymbol=" + stockSymbol + ", lastTradeAmount=" + lastTradeAmount + ", lastTradeDateTime="
				+ lastTradeDateTime + ", stockChange=" + stockChange + ", openAmount=" + openAmount + ", dayHigh="
				+ dayHigh + ", dayLow=" + dayLow + ", stockVolume=" + stockVolume + ", prevCls=" + prevCls
				+ ", changePercent=" + changePercent + ", fiftyTwoWeekRange=" + fiftyTwoWeekRange + ", earnPerShare="
				+ earnPerShare + ", pe=" + pe + ", companyName=" + companyName + ", quoteError=" + quoteError + "]";
	}
