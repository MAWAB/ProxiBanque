...
@ManagedBean(name = "compte2GerantMB")
@ViewScoped
public class Compte_2GerantManagedBean implements Serializable {
	...
	// Constructeur vide
	// -----------------------------------------------------------------------------------------------
	public Compte_2GerantManagedBean() {
		super();
	}
